      ...
      <>
        <Flex gap={'small'} wrap justify='space-around' >
          <Col sm={16} xl={5} md={12} xs={20} className='homePageCard'>
            ...
            <Statistic title={t('users')} value={dashboard.users} formatter={formatter} />
          </Col>
          <Col sm={16} xl={5} md={12} xs={20} className='homePageCard'>
            <div className='homePageCardIcon'>
              <UsergroupAddOutlined />
            </div>
            <Statistic title={t('characters')} value={dashboard.characters} formatter={formatter} />
          </Col>
          <Col sm={16} xl={5} md={12} xs={20} className='homePageCard'>
            <div className='homePageCardIcon'>
              <CarOutlined />
            </div>
            <Statistic title={t('vehicles')} value={dashboard.vehicles} formatter={formatter} />
          </Col>
          <Col sm={16} xl={5} md={12} xs={20} className='homePageCard'>
            <div className='homePageCardIcon'>
              <HomeOutlined />
